...
export async function GET() {
  try {
    ...
    const { rows } = await pool.query(
      `SELECT u.id, u.name, u.email, u.email_verified, u.is_admin, u.phone, u.phone_verified, u.email_notifications, u.sms_notifications, p.avatar_url
    ...
    return NextResponse.json({
      user: {
        ...
        phone: rows[0].phone,
        phoneVerified: rows[0].phone_verified,
