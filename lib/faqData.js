export const FAQ_SECTIONS = [
  {
    ...
    items: [
      {
        q: "Er det gratis at bruge Kontorbud?",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Ja. Betalingen håndteres af Stripe, som lever op til de højeste standarder for datasikkerhed (PCI DSS niveau 1). Dine kortoplysninger går aldrig gennem Kontorbuds egne servere.",
      },
      {
