...
ALTER TABLE tasks ADD COLUMN IF NOT EXISTS cvr_number TEXT;
ALTER TABLE tasks ADD COLUMN IF NOT EXISTS deadline_date DATE;
ALTER TABLE tasks ADD COLUMN IF NOT EXISTS location_type TEXT NOT NULL DEFAULT 'remote';
...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS portfolio_filename TEXT;
...
ALTER TABLE profiles ADD COLUMN IF NOT EXISTS video_call_url TEXT;
